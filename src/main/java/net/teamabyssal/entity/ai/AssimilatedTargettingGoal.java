...
public class AssimilatedTargettingGoal extends Goal {


    private final Assimilated mob;
    public AssimilatedTargettingGoal(Assimilated mob) {
        this.mob = mob;
    }
    @Override
    ...
    public void Targeting(Entity entity){
        ...
        for (Entity entity1 : entities) {
            if(entity1 instanceof Infector livingEntity) {
